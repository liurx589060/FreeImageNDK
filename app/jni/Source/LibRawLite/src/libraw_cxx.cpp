...
#include <byteswap.h> /* TODO luxutag add for bswap_16() */
...
//TODO luxutag add start
void swabInner(const void *from, void *to, ssize_t n) {
        ...
        if ( write_thumb == &LibRaw::jpeg_thumb)
        ...
        else if (write_thumb == &LibRaw::ppm16_thumb)
          {
            ...
            if ((libraw_internal_data.unpacker_data.order == 0x4949) == (ntohs(0x1234) == 0x1234))
              swabInner ((char*)t_thumb, (char*)t_thumb, T.tlength*2);
